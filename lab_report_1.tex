...
\end{table}
	...
	\end{item}		
		...
		\begin{item}	
			ComplexCI is better in speed in the process of reinsertion excluding running CI. Using disjoint-set strategy in ComplexCi performs more efficiently than original reinsertion algorithm in CI\_HEAP. In table \ref{tab:table10} and table \ref{tab:table11}, 
		\end{item}	
	...
	\subsection{Algorithm}
	 ...
	 Reinsertion algorithm does not require that the reinserted node joins the clusters of smallest sizes, but only the minimum number of clusters, independently from their sizes.
